...
<template>
  ...
  <div class="w-full flex flex-col min-[616px]:gap-x-[0.75rem] gap-y-[0.75rem] items-center justify-center">
    <CdxButton weight="primary" action="progressive"
      class="w-full py-[0.3125rem] max-w-[unset] rounded-[0.125rem] h-[2.75rem]" @click="gotoSession">
    ...
    <a href="https://www.wikidata.org/wiki/Wikidata:Lexica#How_to_use" class="w-100" tabindex="-1">
      <CdxButton class="w-100 py-[0.3125rem] max-w-[unset] rounded-[0.125rem] h-[2.75rem]">
...
.menu {
  @apply border border-[var(--border-color-base)] rounded-[0.125rem] p-[0.75rem];
}
</style>
