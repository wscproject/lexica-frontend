<script setup>
/**
 * Script Review Component - Final confirmation interface for script writing conversions
 * 
 * Displays a preview of the script/writing system conversion for a lexeme,
 * allowing users to review their transliteration or script conversion before final submission.
 * 
 * @component
 */
 ...
 * @emits backtoItem - Triggered when user wants to go back to script input
 * @emits onDone - Triggered when user confirms with payload {contributionDetailId, lemma}
 */
 ...
 * @prop {Object} data - Lexeme information including script variant data
 * @prop {Object} detail - Converted text in target script
      ...
      <div class="p-[0.75rem] bg-[#eaecf0] dark:bg-[#27292D]">
        <div class="flex gap-x-2 items-start">
          ...
          <div class="">
            ...
            <span class="text-[1rem] text-[var(--color-subtle)]">{{
              props.detail
            }}</span>
          </div>
        </div>
