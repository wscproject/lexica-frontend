      ...
      <div class="h-full w-full" v-if="senses.length !== 0 && !props.isLoading">
        ...
        <div v-for="sense in senses" class="pb-[0.25rem] w-full">
          ...
          ">
            ...
            "
              class="text-[1rem] p-[var(--spacing-75)] mb-[var(--spacing-50)] bg-[var(--background-color-base)] border border-[var(--border-color-base)] rounded-[0.1250rem] flex">
            ...
            <div v-else-if="data.label === 'images'"
              class="flex gap-x-[0.75rem] mb-[var(--spacing-50)] border border-[var(--border-color-base)] rounded-[0.1250rem] p-[0.75rem] w-full">
              <div class="relative">
            ...
            <div v-else-if="
              ...
              // data.label !== 'otherGlosses'
            "
              class="mb-[var(--spacing-50)] border border-[var(--border-color-base)] p-[0.75rem] rounded-[0.1250rem] flex flex-col w-full">
